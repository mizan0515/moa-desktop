...
- Pi interactive lane 도 conversational 후보에 포함한다. Pi session tree 는 T15f 이후 MoA journal/ResumePacket 을 대체하지 않는 mirror 로만 활성화하고, 그 전에는 blocked/stub event 로 처리한다.
...
| **T14** | 7 | `src-tauri/src/conversation/*`, `src/components/ConversationPanel.tsx`, `src/components/ThinkingBlock.tsx` | T13 commands/lifecycle/scanner, adapters, T15b/T15c Pi lane/session; T15f only for session tree mirror | T13, T15b or T15c; T15f gates session tree features |
