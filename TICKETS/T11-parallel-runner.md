...
[작업 완료 시]
- commit: `feat(T11): parallel session runner + worktree pool + resource budget + lock ordering`
- push 금지
- 보고: lane lifecycle 다이어그램, deadlock test 결과, RSS watchdog 발화 시나리오, T12 integrator 가 본 lane 결과를 어떻게 소비하는지
```
